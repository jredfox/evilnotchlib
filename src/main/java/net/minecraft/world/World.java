...
//	private CapContainer<World> capContainer;
                ...
                catch (Throwable throwable)
                {
                    ...
                    crashreportcategory.addDetail("Source block type", new ICrashReportDetail<String>()
                    {
                        public String call() throws Exception
                        {
                            try
                            {
                                return String.format("ID #%d (%s // %s)", Block.getIdFromBlock(changedBlock), changedBlock.getUnlocalizedName(), changedBlock.getClass().getCanonicalName());
                            }
                            catch (Throwable var2)
                            {
