...
public abstract class PlayerList2
{
    ...
    public PlayerList2(MinecraftServer server)
    {
...
//        System.out.println("nbt of player:" + nbttagcompound + " Dimension:" + playerIn.dimension);
    ...
    public void setPlayerManager(WorldServer[] worldServers)
    {
        ...
        worldServers[0].getWorldBorder().addListener(new IBorderListener()
        {
            ...
            {
                PlayerList2.this.sendPacketToAllPlayers(new SPacketWorldBorder(border, SPacketWorldBorder.Action.SET_SIZE));
            }
            public void onTransitionStarted(WorldBorder border, double oldSize, double newSize, long time)
            {
                PlayerList2.this.sendPacketToAllPlayers(new SPacketWorldBorder(border, SPacketWorldBorder.Action.LERP_SIZE));
            }
            public void onCenterChanged(WorldBorder border, double x, double z)
            {
                PlayerList2.this.sendPacketToAllPlayers(new SPacketWorldBorder(border, SPacketWorldBorder.Action.SET_CENTER));
            }
            public void onWarningTimeChanged(WorldBorder border, int newTime)
            {
                PlayerList2.this.sendPacketToAllPlayers(new SPacketWorldBorder(border, SPacketWorldBorder.Action.SET_WARNING_TIME));
            }
            public void onWarningDistanceChanged(WorldBorder border, int newDistance)
            {
                PlayerList2.this.sendPacketToAllPlayers(new SPacketWorldBorder(border, SPacketWorldBorder.Action.SET_WARNING_BLOCKS));
            }
    ...
    {   
    	...
    	NBTTagCompound cache = EntityUtil.nbts.get(player.getUniqueID());
    	if(cache != null)
    	{
