...
import com.evilnotch.iitemrender.handlers.RenderItemObj;
...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    private void init() throws LWJGLException, IOException
    {
        ...
        net.minecraftforge.fml.client.FMLClientHandler.instance().beginMinecraftLoading(this, this.defaultResourcePacks, this.mcResourceManager, this.metadataSerializer);
        ...
        this.renderItem = new RenderItemObj(new RenderItem(this.renderEngine, this.modelManager, this.itemColors));
