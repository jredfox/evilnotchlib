...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    {
        return networkPlayerInfoIn.getDisplayName() != null ? ScorePlayerTeam.formatPlayerName(networkPlayerInfoIn.getPlayerTeam(),networkPlayerInfoIn.getDisplayName().getUnformattedText()) : ScorePlayerTeam.formatPlayerName(networkPlayerInfoIn.getPlayerTeam(), networkPlayerInfoIn.getGameProfile().getName());
    }
