...
public class Config {
	...
	public static String[] skinDomains = new String[]{".minecraft.net", ".mojang.com", "crafatar.com", "www.minecraftskins.com", "minecraft.novaskin.me", "static.planetminecraft.com", "skinmc.net"};
