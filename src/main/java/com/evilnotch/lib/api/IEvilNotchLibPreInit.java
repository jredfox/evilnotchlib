...
public interface IEvilNotchLibPreInit {
	 ...
	 * This is so you can use the SkinCache while having normal benifets of EvilNotchLib and not hotload everything in your mod's constructor if you plan to actually use EvilNotchLib's other APIs
	 */
