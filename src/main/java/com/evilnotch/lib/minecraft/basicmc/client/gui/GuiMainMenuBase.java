...
public class GuiMainMenuBase extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        modUpdateNotification = notificationInit(this, modButton);
    }
    public static NotificationModUpdateScreen notificationInit(GuiScreen guiMainMenu, GuiButton modButton)
    {
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        ...
        if (this.areRealmsNotificationsEnabled())
        {
        	try
        	{
        		GuiScreen realms = this.realmsNotification;
        		Method m = GuiScreen.class.getDeclaredMethod("mouseClicked", int.class,int.class,int.class);
        		m.setAccessible(true);
        		m.invoke(this.realmsNotification, mouseX, mouseY, mouseButton);
        	}
        	catch(Throwable t)
        	{
        		t.printStackTrace();
